    ...
    <div className="min-h-screen bg-neutral-400/40 font-montserrat">
      ...
      <main className="w-full px-4 pb-16 mx-auto mt-20 max-w-7xl">
        <div className="mb-16 text-center">
          <AnimatedTitle title="NUESTROS PROYECTOS" firstLineWords={1} secondLineWords={1} trigger={1} className="font-medium 2xl:text-8xl xl:text-7xl lg:text-6xl font-oswald"/>
